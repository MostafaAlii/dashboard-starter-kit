...
const ForgotPasswordPage = () => {
  ...
  return (
    <AuthBackground>
      <AuthCard
        title={isRTL ? '📧 نسيت كلمة المرور' : '📧 Forgot Password'}
        subtitle={isRTL ? 'أدخل بريدك الإلكتروني وسنرسل لك رابط إعادة التعيين' : 'Enter your email and we\'ll send you a reset link'}
      >
        <ForgotPasswordForm />
